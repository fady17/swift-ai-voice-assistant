...
export default function Home() {
  ...
  const [shouldStore, setShouldStore] = useState<boolean | null>(null); // New state for storing conversation consent
  ...
  >(async (prevMessages, data) => {
    ...
    // Include the consent information
    if (shouldStore !== null) {
      formData.append("shouldStore", JSON.stringify(shouldStore));
    }
  ...
  function handleFormSubmit(e: React.FormEvent) {
    e.preventDefault();
    if (shouldStore === null) {
      // Prompt the user for consent to store the conversation
      if (window.confirm("Do you want to store this conversation?")) {
        setShouldStore(true);
      } else {
